...
/**
 * The mod_euroaspire evidence uploaded event.
 *
...
/**
 * The mod_euroaspire evidence uploaded event class.
 *
 * @package    mod_euroaspire
 * @copyright  2015 Davo Smith, Synergy Learning
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class evidence_uploaded extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        return "The user with id '$this->userid' has added evidence to the euroaspire " .
    ...
    public static function get_name() {
        return get_string('eventevidenceuploaded', 'mod_euroaspire');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'euroaspire', 'upload evidence', $logurl, $this->objectid, $this->contextinstanceid);
    }
