...
/**
 * The mod_euroaspire submission viewed event.
 *
...
/**
 * The mod_euroaspire submission viewed event class.
 *
 * @package    mod_euroaspire
 * @copyright  2015 Davo Smith, Synergy Learning
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class submission_viewed extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has viewed the submission for user '$this->relateduserid' for the ".
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'euroaspire', 'view submission', $logurl, $this->objectid, $this->contextinstanceid);
    }
