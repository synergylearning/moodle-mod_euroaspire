...
/**
 * The mod_euroaspire submission submitted event.
 *
...
/**
 * The mod_euroaspire submission submitted event class.
 *
 * @package    mod_euroaspire
 * @copyright  2015 Davo Smith, Synergy Learning
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class submission_submitted extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has submitted their submission to the euroaspire " .
    ...
    public static function get_name() {
        return get_string('eventsubmissionsubmitted', 'mod_euroaspire');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'euroaspire', 'submit submission', $logurl, $this->objectid, $this->contextinstanceid);
    }
