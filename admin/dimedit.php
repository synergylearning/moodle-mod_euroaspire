...
$dimid = optional_param('id', null, PARAM_INT);

$url = new moodle_url('/mod/euroaspire/admin/dimedit.php', array('cmid' => $cmid));
if ($dimid) {
    $url->param('id', $dimid);
}
$PAGE->set_url($url);
...
echo $output->header();
echo $output->dimension_edit($manager);
echo $output->footer();
