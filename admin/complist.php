...
$url = new moodle_url('/mod/euroaspire/admin/complist.php', array('cmid' => $cmid));
$PAGE->set_url($url);
...
$manager = new \mod_euroaspire\local\control\compmanager($course, $cm, $euroaspire);
...
echo $output->header();
echo $output->competency_list($manager);
echo $output->footer();
