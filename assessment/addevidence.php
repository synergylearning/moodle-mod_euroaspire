...
/**
 * Add / update evidence to an assessment
 *
...
$url = new moodle_url('/mod/euroaspire/assessment/addevidence.php', array('id' => $id));
$PAGE->set_url($url);
...
$assessmentmanager->process_add();

$output = $assessmentmanager->get_renderer();
echo $output->header();
echo $output->assessment_add_evidence($assessmentmanager);
echo $output->footer();
